...
latex_documents = [
    (master_doc, "AGFusion.tex", "AGFusion Documentation", "Charlie Murphy", "manual"),
]
...
man_pages = [(master_doc, "agfusion", "AGFusion Documentation", [author], 1)]
